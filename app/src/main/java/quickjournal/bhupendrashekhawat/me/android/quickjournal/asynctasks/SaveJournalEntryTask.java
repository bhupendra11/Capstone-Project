/*
package quickjournal.bhupendrashekhawat.me.android.quickjournal.asynctasks;
...
public class SaveJournalEntryTask extends AsyncTask<Movie, Integer, Integer> {
    ...
    public SaveJournalEntryTask(Context context, View view) {
        mContext = context;
        this.rootView = view;
